 ...
 * @since 1.9
 */
public class MCHPortletControllerUtil {
	
	private static final Log log = LogFactory.getLog(MCHPortletControllerUtil.class);
	...
	public static void addFormToEditAndViewUrlMaps(Map<String, Object> model) {
        ...
        List<Extension> handlers = ModuleFactory.getExtensions("org.openmrs.module.mch.extension.html.MCHEncountersDashboard", MEDIA_TYPE.html);
